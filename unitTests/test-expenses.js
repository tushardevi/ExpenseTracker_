...
test('ADD EXPENSE  : missing date', async test => {
	...
	const data = {date: '' ,label: 'party' , category: 'Food', descrip: 'meeting', amount: 394, userid: 3}
...
test('ADD EXPENSE  : missing label', async test => {
	...
	const expenses = await new Expenses()
	const data = {date: '2020-02-12' ,label: '' , category: 'Food', descrip: 'meeting', amount: 394, userid: 3}
...
test('ADD EXPENSE  : missing description', async test => {
	...
	const expenses = await new Expenses()
	const data = {date: '2020-02-12' ,label: 'party' , category: 'Food', descrip: '', amount: 394, userid: 3}
...
test('ADD EXPENSE  : missing amount', async test => {
	...
	const expenses = await new Expenses()
	const data = {date: '2020-02-12' ,label: 'party' , category: 'Food', descrip: 'meeting', amount:'', userid: 3}
...
test('ADD EXPENSE  : missing image', async test => {
	...
	const expenses = await new Expenses()
	const data = {date: '2020-02-12' ,label: 'party' , category: 'Food', descrip: 'meeting', amount:199, userid: 3}
...
test('ADD EXPENSE  : check for integer when entering amount', async test => {
	...
	const expenses = await new Expenses()
	const data = {date: '2020-02-12' ,label: 'party' , category: 'Food', descrip: 'meeting', amount:'hi', userid: 3}
...
test('ADD EXPENSE  : error if invalid date', async test => {
	...
	const expenses = await new Expenses()
	const data = {date: '2021-02-12' ,label: 'party' , category: 'Food', descrip: 'meeting', amount:99, userid: 3}
...
test('APPROVE EXPENSE  : check if expense is approved', async test => {
  ...
  // add new expense
	const expenses = await new Expenses()
	const expense1 = {date: '2020-12-02' ,label: 'associates' , category: 'Food', descrip: 'meeting', amount: 394, userid: 1}
